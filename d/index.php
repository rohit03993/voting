  ...
  <main class="container vote-main">
    ...
    <?php else: ?>
      <form id="votingForm" class="wizard-shell">
        ...
        <div id="instructionMsg" class="alert warn">Enter the director passcode, then vote one position at a time.</div>
        ...
        <section id="stepReview" class="panel wizard-step" hidden>
          ...
          <div class="wizard-nav">
            ...
            <button type="submit" class="btn" id="submitBtn">Submit Director Vote</button>
          </div>
        </section>
